      ...
      <div className="grid grid-cols-2 gap-2.5 sm:gap-5 items-stretch">
        ...
        <div className="flex flex-col gap-2.5 sm:gap-4 justify-between">
          ...
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl p-3 sm:p-6 flex-1 flex flex-col justify-between border-2 border-rose-300/80 shadow-xl shadow-rose-200/50 bg-gradient-to-br from-rose-100/80 via-pink-50/95 to-purple-100/80 backdrop-blur-md">
            ...
            <div className="flex items-center justify-between gap-1.5 sm:gap-2 pb-1.5 sm:pb-2 border-b border-rose-200/80 relative z-10">
              <div className="min-w-0 flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-white/95 border border-rose-200 text-rose-600 text-[10px] sm:text-xs font-extrabold shadow-2xs">
                <span className="text-xs sm:text-sm shrink-0">🌸</span>
                <span className="truncate">
                  <span className="sm:hidden">Günün Notu</span>
                  <span className="hidden sm:inline">Günün Romantik Notu</span>
                </span>
                <span className="text-[10px] sm:text-xs text-pink-500 shrink-0">💌</span>
              </div>
              <button
                onClick={() => {
                  playPop();
                ...
                className={`shrink-0 px-2 sm:px-3 py-0.5 sm:py-1 rounded-xl font-bold text-[10px] sm:text-xs transition-all flex items-center gap-1 cursor-pointer shadow-sm active:scale-95 ${
                  isEditingQuote
                    ? 'bg-rose-100 hover:bg-rose-200 text-rose-700 border border-rose-300'
                    : 'bg-rose-500 hover:bg-rose-600 text-white shadow-rose-200/80'
                }`}
                title={isEditingQuote ? 'Düzenlemeyi kapat' : 'Günün notunu düzenle'}
              >
                {isEditingQuote ? (
                  <>
                  ...
                  <>
                    <Edit3 className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white" />
                    <span>Düzenle</span>
                  </>
                )}
              </button>
